...
Scenario:Smoke test for Gandalf
	...
	#And validate 'Speech clarity' quick button is enabled on 'All-Around' program
	...
	#And I press 'Start from the beginning' on 'THANKS FOR TURNING GUIDING TIPS ON' Guiding tips page
	#And I press 'Next' on 'THANKS FOR TURNING GUIDING TIPS ON' Guiding tips page
	#And I press 'Quite experienced' on 'YOUR EXPERIENCE LEVEL' Guiding tips page
	#And I press 'Go' on 'YOUR EXPERIENCE LEVEL' Guiding tips page
