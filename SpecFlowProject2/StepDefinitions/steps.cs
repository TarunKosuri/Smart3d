...
namespace SpecFlowProject2.StepDefinitions
{
    ...
    { 
        ...
        public steps()
        {
            this.driver = driverinstance._driver;
            demo = new Demo1();
        }
        ...
        public void WhenIPressLegalInformationItem(string p0)
        {
            switch (p0.ToUpper())
            {
                case "MANUFACTURER":
                    page.Manufacturer(p0);
                    break;
        ...
        public void ThenValidatePageTitleIsDisplayedOnManufacturerPage()
        {
            ...
            string actualTitle = page.VerifyManufacturer();
            Assert.AreEqual(expectedTitle, actualTitle, "Title does not match");
        }
        ...
        public void ThenValidatePageTitleIsDisplayedOnTermsAndConditionsPage()
        {
            ...
            string actualTitle = page.Verifyterms();
            Assert.AreEqual(expectedTitle, actualTitle, "Title does not match");
        }
        ...
        public void ThenValidatePageTitleIsDisplayedOnPRIVACYPOLICYPage()
        {
            ...
            string actualTitle = page.Verifyprivacy();
        ...
        public void ThenValidatePageTitleIsDisplayedOnSupportPage()
        {
            ...
            string actualTitle = page.verifysupport();
            Assert.AreEqual(expectedTitle, actualTitle, "Title does not match");
        }
